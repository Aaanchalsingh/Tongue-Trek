...
import './background.scss'; // Import CSS file
import $ from "jquery";

const BackgroundAnimation = () => {
  useEffect(() => {
    // JavaScript code for background animation
    const background = {
      initializr: function() {
        var $this = this;
    ...
    background.initializr(); // Call the initialization function

    // Clean-up function (if needed)
    return () => {
      // Clean-up code here (e.g., removing event listeners)
    };
  ...
  return (
    <>
      ...
      <h2><span>by</span> Enrico Toniato <a href="http://enricotoniato.com" target="_blank" rel="noopener noreferrer">enricotoniato.com</a></h2>
    </>
  );
};
